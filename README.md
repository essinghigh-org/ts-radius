...
- Health-probe length-policy caveat: accounting timeout probes explicitly pass `responseLengthValidationPolicy: "strict"`; CoA/disconnect timeout probe paths do not forward this option and therefore use protocol defaults (currently strict).
